...
"[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminReports() {
    ...
    const [selectedPeriod, setSelectedPeriod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminReports.useEffect": ()=>{
            const fetchReportData = {
                "AdminReports.useEffect.fetchReportData": async ()=>{
                    try {
                        // Fetch applications
                        ...
                        const applications = applicationsSnapshot.docs.map({
                            "AdminReports.useEffect.fetchReportData.applications": (doc)=>doc.data()
                        }["AdminReports.useEffect.fetchReportData.applications"]);
                        // Fetch stock (distributed items)
                        const stockQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "stocks"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("status", "==", "distributed"));
                        const stockSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(stockQuery);
                        const distributedStock = stockSnapshot.docs.map({
                            "AdminReports.useEffect.fetchReportData.distributedStock": (doc_0)=>doc_0.data()
                        }["AdminReports.useEffect.fetchReportData.distributedStock"]);
                        // Calculate statistics
                        const approved = applications.filter({
                            "AdminReports.useEffect.fetchReportData": (app)=>app.status === "approved"
                        }["AdminReports.useEffect.fetchReportData"]).length;
                        const rejected = applications.filter({
                            "AdminReports.useEffect.fetchReportData": (app_0)=>app_0.status === "rejected"
                        }["AdminReports.useEffect.fetchReportData"]).length;
                        const pending = applications.filter({
                            "AdminReports.useEffect.fetchReportData": (app_1)=>app_1.status === "pending"
                        }["AdminReports.useEffect.fetchReportData"]).length;
                        const successRate = applications.length > 0 ? approved / applications.length * 100 : 0;
                        // Calculate faculty impact
                        const facultyMap = new Map();
                        applications.forEach({
                            "AdminReports.useEffect.fetchReportData": (app_2)=>{
                                const faculty = app_2.fakulti || "Tidak Diketahui";
                        ...
                        }["AdminReports.useEffect.fetchReportData"]);
                        ...
                        for(let i = 5; i >= 0; i--){
                            ...
                            const monthApps = applications.filter({
                                "AdminReports.useEffect.fetchReportData.monthApps": (app_3)=>{
                                    const appDate = app_3.createdAt?.toDate ? app_3.createdAt.toDate() : new Date(app_3.createdAt);
                                    return appDate.getMonth() === monthDate.getMonth() && appDate.getFullYear() === monthDate.getFullYear();
                                }
                            }["AdminReports.useEffect.fetchReportData.monthApps"]);
                            const monthApproved = monthApps.filter({
                                "AdminReports.useEffect.fetchReportData": (app_4)=>app_4.status === "approved"
                            }["AdminReports.useEffect.fetchReportData"]).length;
                            monthlyTrend.push({
                                month: monthName,
                        ...
                        setStats({
                            ...
                            totalMoneyDistributed: distributedStock.reduce({
                                "AdminReports.useEffect.fetchReportData": (sum, item)=>sum + (item.estimatedValue || 0)
                            }["AdminReports.useEffect.fetchReportData"], 0),
                            averageProcessingTime: 2.5,
                            // Mock data - would calculate from timestamps
                            successRate,
                            monthlyTrend,
    ...
    const exportToCSV = ()=>{
        const csvContent = [
            ...
            [
                "Makanan Diedarkan",
                stats.totalFoodDistributed
            ],
            [
                "Nilai Wang Diedarkan (RM)",
                stats.totalMoneyDistributed
            ],
            [
                "Masa Prosesan Purata (Hari)",
...
TREND BULANAN
===============
${stats.monthlyTrend.map((t_0)=>`${t_0.month}: ${t_0.applications} permohonan, ${t_0.approved} diluluskan`).join('\n')}

IMPAK MENGIKUT FAKULTI
=========================
${stats.impactByFaculty.map((f_0)=>`${f_0.faculty}: ${f_0.students} pelajar`).join('\n')}
    `;
        ...
        link_0.setAttribute("href", url_0);
        link_0.setAttribute("download", `laporan-kongsirezeki-${new Date().toISOString().split('T')[0]}.txt`);
        link_0.style.visibility = 'hidden';
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                    lineNumber: 182,
                    columnNumber: 11
                }, this)
            }, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Statistik bantuan, outcome & impak program KongsiRezeki."
                        }, void 0, false, {
                            fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                            lineNumber: 193,
                            columnNumber: 11
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                            fillRule: "evenodd",
                                            d: "M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 00-1.414 1.414L9 10.586 7.707a1 1 0 101.414 1.414l2 2a1 1 0 001.414 0z",
                                            clipRule: "evenodd"
                                        }, void 0, false, {
                                            fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                                            lineNumber: 203,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                            fillRule: "evenodd",
                                            d: "M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-5L9 2a1 1 0 00-1 1H4z",
                                            clipRule: "evenodd"
                                        }, void 0, false, {
                                            fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                                            lineNumber: 209,
                    ...
                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: stats.totalStudentsHelped
                                                }, void 0, false, {
                                                    fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                                                    lineNumber: 259,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: stats.totalFoodDistributed
                                                }, void 0, false, {
                                                    fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                                                    lineNumber: 263,
                                                    columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-3",
                                    children: stats.monthlyTrend.map((trend, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: stats.impactByFaculty.map((faculty_0, index_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-gray-50 p-4 rounded-lg",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$kongsirezeki$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "font-semibold text-gray-800 mb-2",
                                            children: faculty_0.faculty
                                        }, void 0, false, {
                                            fileName: "[project]/Documents/Project/kongsirezeki/app/admin/reports/page.tsx",
                                            lineNumber: 307,
                                            columnNumber: 17
...
_s(AdminReports, "cIJqmUa5azlvfn4gtx+twc4gH9w=");
_c = AdminReports;
var _c;
...
//# sourceMappingURL=Documents_Project_kongsirezeki_app_admin_reports_page_tsx_68643e01._.js.map