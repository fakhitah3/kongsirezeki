...
"[project]/Documents/Project/kongsirezeki/app/dashboard/admin/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                "AdminDashboard.useEffect.fetchStats": async ()=>{
                    try {
                        ...
                        const pending = applications.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc)=>doc.data().status === "pending"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        const approved = applications.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_0)=>doc_0.data().status === "approved"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        const rejected = applications.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_1)=>doc_1.data().status === "rejected"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        // Stock stats
                        ...
                        const available = stock.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_2)=>doc_2.data().status === "available"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        const distributed = stock.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_3)=>doc_3.data().status === "distributed"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        const expired = stock.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_4)=>doc_4.data().status === "expired"
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        // Donations stats
                        ...
                        const anonymous = donations.filter({
                            "AdminDashboard.useEffect.fetchStats": (doc_5)=>doc_5.data().isAnonymous
                        }["AdminDashboard.useEffect.fetchStats"]).length;
                        const uniqueDonors = new Set(donations.map({
                            "AdminDashboard.useEffect.fetchStats": (doc_6)=>doc_6.data().userEmail
                        }["AdminDashboard.useEffect.fetchStats"])).size;
                        setStats({
...
_s(AdminDashboard, "7+3yPA1k8FZewJkSR3UojK0xvcg=", false, function() {
    return [
...
//# sourceMappingURL=Documents_Project_kongsirezeki_app_dashboard_admin_page_tsx_e074f3c9._.js.map