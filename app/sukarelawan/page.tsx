        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-black">Bantu Komuniti</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-black">Tambah Pengalaman</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-black">Jaringan Baharu</h3>
              <p className="text-gray-600">
