      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Kempen Aktif</h3>
            <p className="text-3xl font-bold text-green-600">{activeCampaigns}</p>
            <p className="text-sm text-gray-600">Sedang berjalan</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Jumlah Sasaran</h3>
            <p className="text-3xl font-bold text-blue-600">{totalTarget.toLocaleString()}</p>
            <p className="text-sm text-gray-600">Keseluruhan sasaran</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Jumlah Terkumpul</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setFilter({...filter, jenisKempen: e.target.value})}
